...
url = 'http://34.244.187.199:5000/api_v0.1'
...
print("*"*50)
try:
    api_response.raise_for_status()  # raises exception when not a 2xx response
    ...
    print('Request error', api_response.status_code)
print("*"*50)
